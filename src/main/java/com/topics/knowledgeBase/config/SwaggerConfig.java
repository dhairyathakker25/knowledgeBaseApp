...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.topics.knowledgeBase"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("2.0")
                .contact(new Contact("Dhairya Thakker", "https://github.com/dhairyathakker25", "dhairyathakker25@gmail.com"))
                .build();
    }
}
